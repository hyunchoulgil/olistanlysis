...
SELECT 
    (SELECT avg_order_item_price FROM order_items_avg) AS avg_order_item_price,
...
GROUP BY year_week, c.customer_state
ORDER BY year_week, c.customer_state;
